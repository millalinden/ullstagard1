    ...
    <Layout>
      <section className="">
        <div className="flex justify-center">
          <h2 className="font-satoshi font-[900] text-blueberry uppercase lg:text-[10vw] tracking-wide mt-32 mx-5 mb-64 z-10">
            Hitta Hit
          </h2>
        </div>
        <Image src="/images/map.svg" width={500} height={500} className="z-0 absolute bottom-[30%] left-[35%]"/>
        <div className="flex justify-around">
          <p className="font-erode lg:text-[1.4vw] tracking-wide">
            Gåsinge-Ullsta Stora Huset 1<br></br> 646 91 Gnesta<br></br> Sweden
          </p>
          <p className="font-erode lg:text-[1.4vw] tracking-wide">
            Med kollektivtrafik från Stockholm
          </p>
          <p className="font-erode lg:text-[1.4vw] tracking-wide">Med bil från Stockholm</p>
        </div>
