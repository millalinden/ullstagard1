...
export default function Footer() {
  ...
  return (
    <footer className="font-cabinet w-screen bg-[#FAF6EA] h-96 py-6 px-2 relative flex flex-col justify-between lg:justify-around text-blueberry">
      <div className="transform slideUp">
        ...
        <address className="flex justify-between gap-16 items-start py-2 px-3 mb-4 lg:justify-end lg:items-start lg:gap-32 lg:pr-32">
          ...
          <p className="text-[5vw] px-6 not-italic lg:text-[2vw] lg:pb-6">
            Gåsinge-Ullsta Stora Huset <br />
            646 91 Gnesta Sweden
          </p>
        </address>
        <div className="flex justify-between gap-16 items-center py-2 px-3 lg:justify-end lg:items-start lg:gap-40 lg:pr-40 lg:pl-5">
          <p className="text-[5vw] lg:text-[2vw]">Kontakt</p>
          <p className="text-[5vw] not-italic lg:text-[2vw] lg:pb-6">
